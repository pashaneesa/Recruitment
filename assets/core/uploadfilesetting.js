...
uploadsett.setColumn = function(){
    ...
    for(var i = 0; i<set;i++){
        ...
        //console.log(i);
        // $("#field"+i).change(function(){
        //     console.log(i.currentTarget.find("id"));
        //     uploadsett.onSelect($(this).val());
        // });
        

        // console.log(d);
        // if(d != undefined){
        //     uploadsett.columnDetails()[d].name(uploadsett.UploadSettingConfig.detailscolumn()[d].name);
        //     uploadsett.columnDetails()[d].type(uploadsett.UploadSettingConfig.detailscolumn()[d].type);
        //     if(uploadsett.columnDetails()[d].type() == "date"){
        //         uploadsett.columnDetails()[d].condition1(uploadsett.UploadSettingConfig.detailscolumn()[d].condition);
        //     }else{
        //         uploadsett.columnDetails()[d].condition2(uploadsett.UploadSettingConfig.detailscolumn()[d].condition);
        //     }
        //     uploadsett.columnDetails()[d].field(uploadsett.UploadSettingConfig.detailscolumn()[d].field);
        // }
        // $("#field"+i).change(function(){
        //     uploadsett.changeField($(this).val());
        // });
