        ...
        <div class="col-lg-12">
          ...
          <body>
            ...
            <table class="table table-hover">
              ...
              $query = mysqli_query($connect_db, "SELECT * FROM `feedback` ORDER BY `feedback`.`id_feedback` ASC");

              while($data = mysqli_fetch_array($query))
              {
                echo "<tr>";
                echo "<td>$data[1]&nbsp;$data[2]</td>"; //menampilkan data nama
                echo "<td>$data[3]</td>"; //menampilkan data email
                echo "<td>$data[4]</td>"; //menampilkan data fakultas
                // membuat link untuk mengedit dan menghapus data
                echo "<td>$data[5]</td>";
                echo '<td>
                	<a class="btn btn-danger" href="delete_feed.php?id_feedback='.$data[0].'"
                    onclick="return confirm(\'Anda yakin akan menghapus pesan?\')"><img style="" src="../assets/img/delete.png" width="20" height="20"></a>
                </td>';
                echo "</tr>";
