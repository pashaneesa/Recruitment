        ...
        <div class="col-lg-12">
          ...
          <body>
            ...
            <table class="table table-hover">
              ...
              $query = mysqli_query($connect_db, "SELECT * FROM `profile` ORDER BY `profile`.`id_name` ASC");

              while($data = mysqli_fetch_array($query))
              {
                echo "<tr>";
                echo "<td>$data[3]</td>"; //menampilkan data nim
                echo "<td>$data[14]</td>"; //menampilkan data nama
                echo "<td>$data[11]</td>"; //menampilkan data fakultas
                // membuat link untuk mengedit dan menghapus data
                echo '<td>
                  <a class="btn btn-primary" href="edit.php?id_name='.$data[0].'" role="button"><img src="../assets/img/edit.png" width="20" height="20"></a>
                  <a class="btn btn-danger" href="delete.php?id_name='.$data[0].'"
                    onclick="return confirm(\'Anda yakin akan menghapus data?\')"><img style="" src="../assets/img/delete.png" width="20" height="20"></a>
                    <a class="btn btn-warning" href="detail.php?id_name='.$data[0].'" role="button"><img src="../assets/img/detail.png" width="20" height="20"></a>
                </td>';
