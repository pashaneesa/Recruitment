...
<style>
      body{
        background: url(menu_user1.jpg) no-repeat fixed center;
      }
        ...
        <br><br>
          ...
          <div class="form-group">
            ...
            <div class="wow">
                ...
                <h4 >Terdapat beberapa perusahaan yang memiliki lowongan kerja untuk kamu, <br>temukan pekerjaan yang sesuai passion kamu:)</h4>
                1. Langkah pertama yang harus anda lakukan adalah mengisi form <br>
                2. Kemudian pilih perusahaan pada menu formasi <br>
                3. Pesan dari perusahaan yang anda pilih nantinya akan tersedia didalam menu data lamaran<br>
                <br>
