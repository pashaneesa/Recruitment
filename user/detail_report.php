...
$vara = mysqli_query($connect_db, "SELECT * FROM `ambil_formasi` WHERE `id_user` = '$id_user'");
$dataa = mysqli_fetch_array($vara);
$id_per = $dataa['id_per'];

$varaa = mysqli_query($connect_db, "SELECT * FROM `perusahaan` WHERE `id_per` = '$id_per'");
$dataaa = mysqli_fetch_array($varaa);
$nama_per = $dataaa['nama_per'];
