        ...
        <div class="col-lg-12">
          ...
          <body>
           ...
           <div class="col-md-12" style="text-align: right; padding-bottom: 15px;">
              <a class="btn btn-sm btn-danger" href="data_lamaran.php" role="button">Kembali</a>
           </div>
            <table class="table table-hover">
              ...
              $query = mysqli_query($connect_db, "SELECT perusahaan.nama_per, pesan.pesan FROM `pesan`, `perusahaan` WHERE perusahaan.id_per = pesan.id_per AND pesan.id_user = '$id_user' ORDER BY pesan.id_pesan DESC");
              while($data = mysqli_fetch_array($query))
              {
                echo "<tr>";
                echo "<td>$data[0]</td>"; //menampilkan data nim
                echo "<td>$data[1]</td>";
                echo "</tr>";
              }
              ?>
